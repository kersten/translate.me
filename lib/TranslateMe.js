        ...
        self.getLocale.apply(null, [req, function (locale) {
            ...
            self.database.getTranslations({
                ...
                _.each(requestedTranslations, function(t) {
                    if (!result.requestedTranslations[t.path]) {
                        result.requestedTranslations[t.path] = {};
                    }
                    result.requestedTranslations[t.path][t.key] = t.value;
                });
