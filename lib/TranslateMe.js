 ...
 * @constructor
 */
TranslateMe = function (mongoURL, defaultLocale, supportedLocales, getLocale) {
    if(!mongoURL) {
    ...
    if (_.isFunction(getLocale)) {
        this.getLocale = getLocale;
    } else {
        this.getLocale = function (callback) {
            callback(l.Locale['default']);
        }
    }
