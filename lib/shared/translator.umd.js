(function (root, factory) {
    ...
    var Translator = function(translationsHandler, preferredLocale) {
        var masters = translationsHandler.get() || [],
            index = {
                elements: {},
        ...
        this.translate = function (keyOrOptions, namespaceOrContext, localeOrContext, context) {
            ...
            if(this.hasMaster(args.namespace, args.key)) {
                if((translation = index.get(args.namespace, args.key, args.locale))
                    || (translation = index.get(args.namespace, args.key, preferredLocale))) {
                    result = translation;
                }
            } else {
                translationsHandler.createMaster(args.namespace, args.key, function(master) {
                    masters.push(master);
                });
            }
        ...
        /**
         * Calculates the translation stats, based on the translations.
         */
