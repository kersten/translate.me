(function (define, node) {
    ...
    define(["underscore", "jquery", "./traverse.util.js", (node) ? "../translations" : "/translate.me/require/translations"],
            ...
            _.mixin({
                translate: function () {
                    ...
                    if(!args.namespace) {
                        ...
                        args.namespace = args.namespace.substring(3); // Strip "ns:" placeholder if it exists
                    }
                    ...
                    if(translations && translations.requestedTranslations
                        ...
                        if(!_.contains(translations.allKeys, key)) {
                            $.post("/translate.me/translations", {
