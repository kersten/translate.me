_.mixin((function (_, $, translations, stats) {
    ...
    return {
        ...
        translate: function (arg1, arg2, arg3, arg4) {
            ...
            if(translationsByLocale && translationsByLocale[args.locale]
                ...
                result = args.key;
                if(!_.contains(keys[args.namespace], args.key)) {
                    $.post("/translate.me/api/json/translations", {
                        namespace: args.namespace,
                        key: args.key
                    });
                    keys[args.namespace].push(args.key);
                }
            }
...
})(_, $, translateMeTranslations, translateMeStats));
