 ...
 * @constructor
 */
function TranslateMe (mongoURL, defaultLocale, supportedLocales) {
    'use strict';
    ...
    if(this.translator === undefined) {
        this.translator = new Translator({
            ...
            createMaster: function(namespace, key) {
                that.translationStore.createMasterTranslation({
                    namespace: namespace,
                    key: key
                }, 'dynamic');
            }
